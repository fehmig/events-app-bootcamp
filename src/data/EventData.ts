const EventData = [
  {
    ...
    prices: [
      { size: 'Sahne Önü', price: '500', currency: '₺' },
      { size: 'Ayakta Normal', price: '650', currency: '₺' },
      { size: 'VIP', price: '900', currency: '₺' },
    ],
    average_rating: 4.7,
    ratings_count: '6,879',
    favourite: false,
  ...
  },
  {
    ...
    location: [
      { latitude: 39.96035476008762 },
      { longitude: 32.77971108271766 }
    ],
  ...
  },
  {
    ...
    special_ingredient: 'Ankara',
    prices: [
      { size: 'Sahne Önü', price: '400', currency: '₺' },
      { size: 'Ayakta Normal', price: '550', currency: '₺' },
      { size: 'VIP', price: '700', currency: '₺' },
    ],
    average_rating: 4.7,
    ratings_count: '6,879',
    favourite: false,
  ...
  },
  {
    ...
    special_ingredient: 'Ankara',
    prices: [
      { size: 'Sahne Önü', price: '200', currency: '₺' },
      { size: 'Ayakta Normal', price: '350', currency: '₺' },
      { size: 'VIP', price: '600', currency: '₺' },
    ],
    average_rating: 4.7,
    ratings_count: '6,879',
    favourite: false,
  ...
  },
  {
    ...
    Ankara Yeni Sahne oyuncu künyesi
    ...
    location: [
      { latitude: 39.92322501564142 },
      { longitude: 32.85242616922402 }
    ],
  ...
  },
  {
    ...
    prices: [
      { size: 'Balkon', price: '250', currency: '₺' },
      { size: 'Sahne-1', price: '320', currency: '₺' },
      { size: 'Sahne-2', price: '350', currency: '₺' },
    ],
    average_rating: 4.7,
    ratings_count: '6,879',
  ...
  },
  {
    ...
    location: [
      { latitude: 39.93623665904763 },
      { longitude: 32.8251260520276 }
    ],
  ...
  },
  {
    ...
    place: 'Fuar İzmir',
    location: [
      { latitude: 38.4984879676831 },
      { longitude: 27.137868507507825 }
    ],
  ...
  },
  {
    ...
    location: [
      { latitude: 40.74767605448792 },
      { longitude: 29.945019498101832 }
    ],
    ...
    prices: [
      { size: 'Sahne Önü', price: '700', currency: '₺' },
      { size: 'Ayakta Normal', price: '750', currency: '₺' },
      { size: 'VIP', price: '900', currency: '₺' },
    ],
    average_rating: 4.7,
    ratings_count: '6,879',
  ...
  },
  {
    ...
    location: [
      { latitude: 38.00571197861924 },
      { longitude: 32.51703115378588 }
    ],
  ...
  },
  {
    ...
    location: [
      { latitude: 40.739378557027734 },
      { longitude: 30.309859880904526 }
    ],
  ...
  },
  {
    ...
    place: 'Foça Sahili',
    location: [
      { latitude: 38.67157505196444 },
      { longitude: 26.754902342200435 }
    ],
  ...
  },
  {
    ...
    location: [
      { latitude: 39.91640451913674 },
      { longitude: 32.85846799805983 }
    ],
  ...
  },
  {
    ...
    location: [
      { latitude: 41.13607285814144 },
      { longitude: 30.101070932285687 }
    ],
  ...
  },
  {
    ...
    İki meraklı kardeş olan Eda ve Mete, evlerinin tavan arasında eski bir iletişim cihazı bulurlar. Uzayın derinliklerine mesajlar yollamaya, hatta kalkıp uzaya gitmeye karar verirler. Ancak planladıkları yolculukta kullanacakları uzay gemisini tasarlayabilmek için önce bilmeleri gereken tarihi bir bilmece vardır! Neyse ki ikilinin danışabileceği yapay zeka asistanı Asel de bu görevde onlara yardımcı olacaktır!
    
    Bu yapacakları yolculukta yer çekimsiz ortam, roketler, tarihi bilgiler, gök taşları ve eğlenceli şarkılar, onları bekleyen uzay
    macerasının sadece bir bölümüdür!
    ...
    Yapım: Krom Sanat
    Yazan: Burak Bayar
    Yöneten: Çisel Ocak KAR
    Oynayanlar: Büşra HAZAN, Mustafa AKSAKAL, Çisel OCAk KARA
    Müzik: İlke Ulaş KUVANÇ
    ...
    location: [
      { latitude: 39.84705631451646 },
      { longitude: 32.82800243853152 }
    ],
